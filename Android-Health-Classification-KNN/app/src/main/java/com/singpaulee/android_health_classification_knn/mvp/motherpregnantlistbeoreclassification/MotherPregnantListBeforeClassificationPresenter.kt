...
class MotherPregnantListBeforeClassificationPresenter<V : MotherPregnantListBeforeClassificationMvpView>
internal constructor(compositeDisposable: CompositeDisposable, val context: Context) :
    BasePresenter<V>(compositeDisposable), MotherPregnantListBeforeClassificationMvpPresenter<V> {
