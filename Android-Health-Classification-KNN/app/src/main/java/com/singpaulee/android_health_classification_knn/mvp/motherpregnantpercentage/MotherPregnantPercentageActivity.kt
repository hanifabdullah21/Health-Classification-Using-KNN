package com.singpaulee.android_health_classification_knn.mvp.motherpregnantpercentage
...
class MotherPregnantPercentageActivity : AppCompatActivity() {

    var listClassification: ArrayList<MotherPregnantModel>? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_mother_pregnant_percentage)
